...
|--|--|--|--|--|--|
|<a href="https://master.d3q12s0gysig02.amplifyapp.com/">Caturday</a>| A small webapp to keep laerning during furlough. Save, share and discover new gifs! <br> | On going | Javscript/React, HTML, CSS, Webpack, CSS-Modules | Jest, Enzyme | <a href="https://github.com/l-palermo/react-amplify-app">Github</a>|
|<a href="https://app-boilerplate-y-w-l-v-c.now.sh">React Webpack Boileplate</a>| A React - Webpack - Linaria boilerplate to keep on learning during furlough. <br> | On going | Javscript/React, HTML, CSS, Webpack, Linaria | Jest, React Testing Library | <a href="https://github.com/l-palermo/App-boilerplate-Y.W.L.DO.C">Github</a>|
|<a href="https://l-palermo.github.io/App-boilerplate-P.R.GA.GP/">React Rollup Boileplate</a>| A React - Rollup - Linaria boilerplate to keep on learning during furlough. CI/CD GitHub Actions, GitHub Pages  <br> | On going | Javscript/React, HTML, CSS, Rollup, Linaria | Jest, React Testing Library | <a href="https://github.com/l-palermo/App-boilerplate-P.R.GA.GP">Github</a>|
